...
public class api2 {
    @Autowired
    private ChargerInfoItemRepository chargerInfoItemRepository;
    ...
    public void api2Read() throws IOException {
        ...
        Gson gson = new Gson();
        ChargerInfoResponse response = gson.fromJson(sb.toString(), ChargerInfoResponse.class);
    ...
    public void api2read1() throws IOException {
        ...
        while (hasMoreData) {
            try {
                ...
                ChargerInfoResponse response = gson.fromJson(jsonString, ChargerInfoResponse.class);
                List<ChargerInfoItem> items = response.getItems().getItem();
                ...
                for (int i = 0; i < items.size(); i += batchSize) {
                    ...
                    List<ChargerInfoItem> batchList = items.subList(i, end);
